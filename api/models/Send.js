...
var Send={
  ...
  addLog:function(body, callback){
    return db.query("INSERT INTO Logs (timeLogged, glucose, dose, carbs, isCustomDose, note) VALUES (\'" + body.currentTime + "\',\'" + body.glucose + "\',\'" + body.dose + "\',\'" + body.carbs + "\',\'" + body.isCustomDose + "\',\'" + body.notes + "\')", callback);
  },
